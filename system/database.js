module.exports = (m) => {
   ...
   if (setting) {
      ...
      if (!('sk_author' in setting)) setting.sk_author = '@mo7amedbella'
      ...
      if (!('cover' in setting)) setting.cover = 'https://telegra.ph/file/956f20d609491fe54789e.jpg'
      if (!('link' in setting)) setting.link = 'https://chat.whatsapp.com/FfgPIhc3VTj6S5FHCovVIi'
   } else {
      global.db.setting = {
         autodownload: true,
         chatbot: true,
         ...
         msg: 'SALAM +tag 🪸\nI am an automated system (WhatsApp Bot) that can help to do something, search and get data / information only through WhatsApp.\n\n developed by *BELLA*',
         menuStyle: 4,
         cover: 'https://telegra.ph/file/956f20d609491fe54789e.jpg',
         link: 'https://chat.whatsapp.com/FfgPIhc3VTj6S5FHCovVIi'
      }
   }
}
